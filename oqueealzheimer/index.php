...
<main id="alzheimer-main">
    ...
    <div id="title">
        <section class="w-100 d-flex">
            <div class="container w-100">
                <div class="row">
                    <h1 id="title-text" class="col-8">Está na hora de saber o que é doença de Alzheimer</h1>
    ...
    <section class="w-100">
        <div class="container w-100">
            <div class="row">
                <div class="col-12">
                    <div id="page-container" class="d-block d-xl-flex justify-content-xl-between">
